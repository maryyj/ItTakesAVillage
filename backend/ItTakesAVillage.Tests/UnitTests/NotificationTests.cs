namespace ItTakesAVillage.Tests.UnitTests
{
    public class NotificationTests
    {
        ...
        public async Task CountAsync_NotificationsExist_ShouldReturnCorrectCount()
        {
            ...
            // Act
            var actual = await _sut.GetCountAsync(userId);
        ...
        where TEventObject : BaseEvent
        {
            ...
            // Act
            await _sut.CreateAsync(eventObject, userId, eventObject.CreatorId);
        ...
        {
            // Arrange
            Notification notification  = new Notification { Id = 123, IsRead = false };

            // Act
            await _sut.UpdateIsReadAsync(notification);
